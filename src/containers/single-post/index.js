      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{
          ...
          <IconButton onClick={handleLike} >
            {like ? <FavoriteIcon style={{ fontSize: "30px" }} sx={{ color: "red" }} /> : <FavoriteBorderIcon color="primary" style={{ fontSize: '30px' }} />}
          </IconButton>
        ...
        <div style={{
          ...
          <IconButton onClick={handleShow1}>
            <InsertCommentIcon color="primary" style={{ fontSize: '30px' }} />
          </IconButton>
          <div onClick={handleShow1} style={{ color: "white", fontSize: "15px", cursor: 'pointer' }}>{comments.length}</div>
        </div>


        <IconButton onClick={handlebookmark} style={{
          position: "absolute", bottom: "100px", right: 0
        }}>
          {bookmarkpost ? <BookmarkIcon color="primary" style={{ fontSize: '30px' }} /> : <BookmarkBorderOutlinedIcon color="primary" style={{ fontSize: '30px' }} />}
        </IconButton>
        <IconButton onClick={handleShow5} style={{
          ...
          <MoreHorizIcon style={{ fontSize: '30px' }} color="primary" />
        </IconButton>
        <div style={{
